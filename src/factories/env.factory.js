angular.
    ...
    factory('env', function ($http) {
          ...
          return {
            ...
            //TODO get them from selected cluster instead of direct access?
          ...
          function setCluster(clusterName) {
            if(allClusters.length == 0) {
             ...
             if(angular.isUndefined(clusterName)) {
                  ...
                  selectedCluster = filteredArray.length == 1 ?  filteredArray[0]  : allClusters[0]; //allClusters[clusterName];//
             }
          }
          ...
          //TODO Kafka rest for now, do it for backend
