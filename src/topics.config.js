var TOPIC_CONFIG = {
  ...
  CONTROL_TOPICS: ["_confluent-controlcenter", "_confluent-command", "connect-configs", "connect-offsets", "__confluent", "__consumer_offsets", "_confluent-monitoring", "connect-status", "_schemas"]
  };
